...
.post-card:hover {
  ...
  .dark & { border-color: rgba(148, 163, 184, .46); box-shadow: 0 8px 20px rgba(2, 6, 23, .35); }
}
...
.card-cover { width: 120px; height: 80px; border-radius: 10px; overflow: hidden; flex-shrink: 0; background: #e2e8f0; .dark & { background: $color-dark-border; } }
.card-cover img { width: 100%; height: 100%; object-fit: cover; }
.card-body { flex: 1; min-width: 0; }
.card-title { margin: 0 0 .35rem; font-size: 1rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: $color-text; .dark & { color: $color-dark-text; } }
.card-summary { margin: 0; font-size: .86rem; color: $color-text-muted; line-height: 1.5; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; .dark & { color: $color-dark-text-muted; } }
.card-meta { display: flex; align-items: center; gap: .55rem; margin-top: .45rem; font-size: .78rem; color: $color-text-muted; flex-wrap: wrap; .dark & { color: $color-dark-text-muted; } }
...
.unfav-btn {
  ...
  .dark & { background: rgba(148, 163, 184, .14); color: $color-dark-text-muted; }
}
...
.empty-state { .dark & { color: $color-dark-text-muted; border-color: rgba(148,163,184,.32); background: $color-dark-bg-secondary; } }
