        ...
        <div class="three-col-layout" :class="{ 'content-entered': contentEntered }">
          ...
          <div class="center-content detail-enter-block detail-enter-center">
            ...
            <template v-if="currentPost">
              <div class="post-promotion-slot post-promotion-slot--top">
                <PromotionSlotPanel promotion-slot="post_top" />
              </div>
              ...
              <div class="post-promotion-slot post-promotion-slot--bottom">
                <PromotionSlotPanel promotion-slot="post_bottom" />
              </div>
...
.post-content {
  ...
  :deep(.md-image--left img) { margin-left: 0; }
  :deep(.md-image--right img) { margin-right: 0; }
  :deep(.md-image--small img) { width: min(50%, 420px); }
  :deep(.md-image--medium img) { width: min(75%, 720px); }
  :deep(.md-image--wide img),
  :deep(.md-image--full img) { width: 100%; }
}
