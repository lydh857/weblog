    ...
    <div class="footer-shell">
      ...
      <div class="footer-links">
        ...
        <section class="link-group">
          ...
          <button type="button" class="link-btn" @click="openPromotionApplicationModal">广告投放</button>
        </section>

        <section class="link-group">
          <h4>联系与说明</h4>
          <a href="mailto:contact@example.com">商务合作</a>
...
function openPromotionApplicationModal() {
  if (!userStore.isLoggedIn) {
    loginModal.open('code', () => {
      promotionApplicationModal.open()
    })
    return
  }
