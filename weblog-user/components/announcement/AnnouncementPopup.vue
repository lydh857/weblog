        ...
        <div class="popup-envelope-wrap">
          ...
          >
            <article class="popup-letter" role="dialog" aria-modal="true" :aria-label="`信封公告：${currentAnn.title}`">
              ...
              <p class="popup-signature">Weblog</p>
            ...
            <button type="button" class="popup-seal" aria-label="打开公告" @pointerdown.stop.prevent="toggleEnvelopeByTap" @click.stop="toggleEnvelopeByTap">
              SMKY
            </button>
