...
CREATE TABLE `t_carousel`  (
  ...
  `title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '标题（可选）',
...
CREATE TABLE `t_ip_blacklist`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `block_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '封禁类型: IP/USER/MUTE',
  `target_value` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '封禁对象值: IP或用户ID',
  `user_id` bigint NULL DEFAULT NULL COMMENT '封禁用户ID(USER/MUTE类型)',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '统一黑名单表（IP/用户/禁言）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_post`  (
  ...
  `is_top` tinyint(1) NULL DEFAULT 0 COMMENT '是否置顶',
  `topic_only` tinyint(1) NULL DEFAULT 0 COMMENT '是否仅在专题内展示',
  ...
  INDEX `idx_topic_only`(`topic_only` ASC) USING BTREE,
...
CREATE TABLE `t_user`  (
  ...
  `muted_permanent` tinyint(1) NULL DEFAULT 0 COMMENT '是否永久禁言',
  `muted_until` datetime NULL DEFAULT NULL COMMENT '禁言截止时间',
  `muted_reason` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '禁言原因',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `is_deleted` tinyint(1) NULL DEFAULT 0 COMMENT '软删除',
  PRIMARY KEY (`id`) USING BTREE,
