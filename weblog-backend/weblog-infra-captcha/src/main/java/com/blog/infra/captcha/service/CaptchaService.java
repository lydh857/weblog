...
public interface CaptchaService {
     ...
     */
    CaptchaGenerateVO generateCaptcha(String scene, CaptchaRiskContext context);
     ...
     * 刷新验证码（删除旧数据、生成新验证码）
     */
    CaptchaGenerateVO refreshCaptcha(String oldToken, String scene, CaptchaRiskContext context);
     ...
     * @return true 表示有效
     */
    boolean validateVerifyToken(String verifyToken, String clientIp, String scene);

    /**
     * 校验 Verify_Token，无效时抛出 BusinessException
     */
    void validateVerifyTokenOrThrow(String verifyToken, String clientIp, String scene);
}
