...
private final FriendLinkService friendLinkService;
    ...
    public Result<FriendLink> applyLink(@Valid @RequestBody FriendLinkApplyRequest body) {
        ...
        FriendLink link = friendLinkService.applyLink(
            userId,
            body.getName(),
            body.getUrl(),
            body.getLogo(),
        ...
        reviewMailActionService.sendPendingFriendLinkReviewEmail(link.getId());
    ...
    public Result<FriendLink> updateMyLink(@Valid @RequestBody FriendLinkApplyRequest body,
        ...
        StpUtil.checkLogin();
        Long userId = StpUtil.getLoginIdAsLong();
        FriendLink link = friendLinkService.updateMyLink(
            userId,
            body.getName(),
            body.getUrl(),
            body.getLogo(),
