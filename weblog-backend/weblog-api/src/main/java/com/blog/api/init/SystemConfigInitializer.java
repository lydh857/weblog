...
public class SystemConfigInitializer {
    ...
    public void init() {
        ...
        systemConfigService.createIfAbsent("site_footer_copyright", "© 2026 Weblog. All rights reserved.", "站点页脚版权文案");
        ...
        systemConfigService.createIfAbsent("review_action_base_url", "http://localhost:3000", "邮件快捷审核链接基础地址");
        ...
        systemConfigService.createIfAbsent(EmailDomainPolicyService.ALLOWED_EMAIL_DOMAINS_KEY, EmailDomainPolicyService.DEFAULT_ALLOWED_EMAIL_DOMAINS, "允许注册/绑定的邮箱后缀白名单（逗号分隔）");
