    ...
    <div class="login-container">
      ...
      <div class="brand-panel">
        <div class="brand-inner">
          <div class="brand-logo">
            <img src="/brand/logo.png" :alt="siteName + ' logo'" class="brand-logo-img app-brand-logo">
          </div>
          <h2 class="brand-name">{{ siteName }}</h2>
      ...
      <div class="form-panel">
        <div class="form-inner">
          ...
          <p class="copyright">{{ siteCopyright }}</p>
        </div>
      </div>
    </div>
...
const siteCopyright = computed(() => siteConfigState.value.siteCopyright)

useHead({ title: () => `${siteName.value} 管理端` })
