<template>
  <div class="startup-splash" role="status" aria-live="polite" aria-busy="true" aria-label="页面加载中">
...
.startup-splash {
  ...
  --splash-soft: #b8d3ff;
  --splash-floor: #d7e5ff;
  --splash-shadow: rgba(36, 57, 92, 0.28);
  position: fixed;
  inset: 0;
  z-index: 3000;
  background:
    radial-gradient(circle at 20% 20%, rgba(91, 141, 239, 0.18), transparent 42%),
    radial-gradient(circle at 78% 24%, rgba(91, 141, 239, 0.12), transparent 44%),
    var(--el-bg-color-page);
  overflow: hidden;
}

:global(html.dark) .startup-splash {
  --splash-ink: #9fb5d8;
  --splash-soft: #5d7fb3;
  --splash-floor: #2a3446;
  --splash-shadow: rgba(0, 0, 0, 0.55);
}
...
.floor {
  ...
  box-shadow: 0px 2px 8px var(--splash-shadow);
  z-index: 2;
}
...
.candle1 {
  ...
  height: 100px;
  background: #fff;
  border: 3px solid var(--splash-ink);
  border-bottom: 0px;
  border-radius: 3px;
  transform-origin: center right;
  transform: translate(60%, -25%);
  box-shadow: -2px 0px 0px var(--splash-soft) inset;
...
.candle2__eyes-one {
  ...
  border: 0px solid var(--splash-ink);
  border-radius: 100%;
  float: left;
  background: var(--splash-ink);
